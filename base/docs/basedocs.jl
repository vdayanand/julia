...
Stacktrace:
 [1] getindex(::Array{Float64,1}, ::Int64) at ./array.jl:748
...
Stacktrace:
 [1] getindex(::Array{Float64,2}, ::Int64, ::Int64) at ./array.jl:749

julia> B[9]
ERROR: BoundsError: attempt to access 2×3 Array{Float64,2} at index [9]
Stacktrace:
 [1] getindex(::Array{Float64,2}, ::Int64) at ./array.jl:748
```
"""
BoundsError
