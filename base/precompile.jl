...
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{IO}, Null}}})
precompile(Tuple{Type{Base.Union{Some{IO}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{AbstractString}, Null}}})
precompile(Tuple{Type{Base.Union{Some{AbstractString}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Integer}, Null}}})
precompile(Tuple{Type{Base.Union{Some{Integer}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Union{Int64, Symbol}}, Null}}})
precompile(Tuple{Type{Base.Union{Some{Union{Int64, Symbol}}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Base.Cmd}, Null}}})
precompile(Tuple{Type{Base.Union{Some{Base.Cmd}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Any}, Null}}})
precompile(Tuple{Type{Base.Union{Some{Any}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Bool}, Null}}})
precompile(Tuple{Type{Base.Union{Some{Bool}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Base.Process}, Null}}})
precompile(Tuple{Type{Base.Union{Some{Base.Process}, Null}}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Base.Dict{K, V}}, Null} where V where K}})
precompile(Tuple{Type{Base.Union{Some{Base.Dict{K, V}}, Null} where V where K}})
precompile(Tuple{typeof(Base.eltype), Type{Base.Union{Some{Array{T, N}}, Null} where N where T}})
precompile(Tuple{Type{Base.Union{Some{Array{T, N}}, Null} where N where T}})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.Process}, Null}}, Base.Process})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Bool}, Null}}, Bool})
...
precompile(Tuple{typeof(Base.unpreserve_handle), Base.Timer})
precompile(Tuple{typeof(Base.disassociate_julia_struct), Base.Timer})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{AbstractString}, Null}}, Base.SubString{String}})
...
precompile(Tuple{typeof(Base.print), Base.GenericIOBuffer{Array{UInt8, 1}}, Base.TCPSocket})
precompile(Tuple{typeof(Base.isopen), Base.TCPSocket})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{AbstractString}, Null}}, String})
precompile(Tuple{typeof(Base.unpreserve_handle), Base.TCPSocket})
precompile(Tuple{typeof(Base.check_open), Base.TCPSocket})
precompile(Tuple{typeof(Base.stream_wait), Base.TCPSocket, Base.Condition})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.VersionNumber}, Null}}, Base.Union{Some{Base.VersionNumber}, Null}})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Distributed.WorkerConfig}, Base.Distributed.WorkerConfig})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.VersionNumber}, Null}}, Base.VersionNumber})
precompile(Tuple{typeof(Base.Distributed.send_connection_hdr), Base.Distributed.Worker, Bool})
precompile(Tuple{typeof(Base.unsafe_write), Base.TCPSocket, Ptr{UInt8}, UInt64})
...
precompile(Tuple{typeof(Base.get), Base.Union{Some{Base.Dict{K, V}}, Null} where V where K, Base.Dict{Any, Any}})
...
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.Dict{K, V}}, Null} where V where K}, Base.Dict{Any, Any}})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Integer}, Null}}, Int64})
precompile(Tuple{typeof(Base.convert), Type{Base.Union{Some{Base.VersionNumber}, Null}}, Base.VersionNumber})
